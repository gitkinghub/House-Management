# Generated by Django 5.1.7 on 2025-04-18 10:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NC', 'Not Complete'), ('C', 'Complete')], default='NC', max_length=255)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='list', to='users.profile')),
